...
async def retrieve_hybrid(
    ...
    Args:
        ...
        video_ids: Optional per-conversation video scope (issue #279). When a
            non-empty list is supplied, both the keyword and vector searches
            are restricted to those video_ids; None/empty searches the whole
            library (today's behaviour).
