...
async def retrieve_hybrid(
    ...
    Args:
        ...
        scope_video_ids: Conversation video scope (issue #279). When a
            non-empty list, both searches are restricted to those videos at
            the SQL layer. None = whole library (default behavior).
