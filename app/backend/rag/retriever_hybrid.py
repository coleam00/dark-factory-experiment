...
async def retrieve_hybrid(
    ...
    Args:
        ...
        video_ids: Conversation-scope filter (issue #279). None means
            unscoped — search all videos; a non-empty list is a hard filter
            applied to both the keyword and vector legs at the SQL layer.
